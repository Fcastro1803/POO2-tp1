...
public class PedidosTest {
    ...
    void testCalculoCostoConTarjetaVisa() {
        ...
        Pedido pedido1 = new Pedido(new ArrayList<>(), new ArrayList<>(), mesa1, LocalDate.of(2026, 5, 20), new FakeRegistroPedidos());
    ...
    // Clase interna Fake para evitar conexión a BD en tests
    private static class FakeRegistroPedidos implements RegistroPedido {
        @Override
